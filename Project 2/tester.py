...
from player_phase1_copy import UGPlayerPhase1_4001022222 as player_class2
import random
...
class UltimatumGameTester:
    ...
    def run(self):
        ...
        # print(
        #     f"Player 1 ({self.player1_class.__name__}) score: {player1_score}")
        # print(
        #     f"Player 2 ({self.player2_class.__name__}) score: {player2_score}")
